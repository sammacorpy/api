...
<body style="background-image:url('css/b2.jpg');background-repeat:no repeat; background-attachment:fixed;">
<form>
<div id="wrapper">
<div id="header">
<div id="logo">
...
<div id="main">
<h2 style="color:blue; text-align:center; margin:0px; padding:40px;">Your Symptoms may be due to...</h2>
<table align="center" border="1" cellspacing="0px" cellpadding="10px">
<tr>
<th>Disease</th>
<th>Symptoms</th>
<th><a href="curesp.php">See Cure!</a></th>
<th><a href="listofdocp.php">Visit Doctor</a></th>
</tr>
<?php
require('connectp.php');
$res=mysqli_query($con,"select Disease,Symptoms from symptom_checker");
$n=1;
...
<td><a href="curesp.php?Symptoms=<?php echo $row[1] ?>">See Cure!</a></td>
<td><a href="listofdocp.php?Disease=<?php echo $row[0] ?>">Visit Doctor!</a></td>
</tr>
<?php
$n++;
}
